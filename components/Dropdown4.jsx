...
function Dropdown() {
    ...
    return (
        <>
            <div
                onClick={() => setOp(!op)}
                className="onClick={() => setOp(!op)}     outline-none pl-[30px]   rounded-[5px]   w-[148px]  h-[54px]  "
            >
                <Listbox value={selected} onChange={setSelected}>
                    <div className="relative ">
                        ...
                        <Transition
                            ...
                            leaveTo="opacity-0"
                        >
                            <Listbox.Options className="absolute  w-full max-w-[150px] overflow-auto    rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm ">
